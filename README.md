...
| Zapier Pro 무료 체험 대시보드 | ![Zapier Pro 무료 체험 대시보드](images/02_Zapier_대시보드_Pro무료체험.png.png) |
| Make 전체 시나리오와 Router 분기 | ![Make 전체 시나리오](images/03_Make_전체시나리오_Router분기.png) |
| Zapier 합격 처리 Zap 전체 구성 | ![Zapier 합격 Zap](images/14_Zapier_합격Zap_전체구성.png.png) |
| Zapier 불합격 처리 Zap 전체 구성 | ![Zapier 불합격 Zap](images/20_Zapier_불합격Zap_전체구성.png.png) |
| Zapier 두 Zap 활성화 목록 | ![Zapier 두 Zap 활성화](images/24_Zapier_두Zap_Live목록.png.png) |

#### 조건 설정과 시간대 변환

| 항목 | 이미지 |
|---|---|
| Make Router 합격 필터 | ![Make 합격 필터](images/04_Make_Router_합격필터_80점이상.png.png) |
| Make Router 불합격 필터 | ![Make 불합격 필터](images/05_Make_Router_불합격필터_80점미만.png.png) |
| Zapier 합격 필터 | ![Zapier 합격 필터](images/16_Zapier_합격필터_80점이상.png.png) |
| Zapier 시간대 변환 Formatter | ![Zapier 시간대 변환](images/17_Zapier_시간대변환_Formatter설정.png.png) |
| Zapier 불합격 필터 | ![Zapier 불합격 필터](images/21_Zapier_불합격필터_80점미만.png.png) |

#### 실행 결과와 로그

| 항목 | 이미지 |
|---|---|
| Make 합격 경로 실행 성공 | ![Make 합격 실행](images/06_Make_합격경로_실행성공.png.png) |
| Make 불합격 경로 실행 성공 | ![Make 불합격 실행](images/07_Make_불합격경로_실행성공.png.png) |
| Make 실행 History | ![Make History](images/11_Make_History_전체실행목록.png.png) |
| Zapier 합격자 시트 결과 | ![Zapier 합격자 결과](images/25_Zapier_최종결과_합격자시트.png.png) |
| Zapier 불합격자 시트 결과 | ![Zapier 불합격자 결과](images/26_Zapier_최종결과_불합격자시트.png.png) |
| Zapier Discord 최종 알림 | ![Zapier Discord 알림](images/27_Zapier_최종결과_Discord알림.png.png) |
| Zapier 실행 History | ![Zapier History](images/28_Zapier_History_전체실행목록.png.png) |
| Zapier Filtered 상세 로그 | ![Zapier Filtered 로그](images/29_Zapier_History_Filtered_상세로그.png.png) |
| Zapier Task 사용량 | ![Zapier Task 사용량](images/30_Zapier_TaskUsage_사용량현황.png.png) |

> 모든 스크린샷에서 Webhook URL, 이메일 주소, 계정 정보 등 민감정보는 마스킹하거나 화면에서 제외하였다.

> **GitHub 이미지 파일명 주의:** 현재 업로드된 파일 중 `01`과 `03`을 제외한 파일은 실제 이름이 `.png.png`로 저장되어 있다. 이 보고서는 현재 GitHub 파일명과 일치하도록 이미지 경로를 수정한 버전이다. Windows에서 파일 확장자가 숨겨진 상태로 `.png`를 추가 입력하면 이중 확장자가 생길 수 있다.
...
| 02 | `02_Zapier_대시보드_Pro무료체험.png.png` | Zapier Pro 무료 체험 대시보드 |
| 03 | `03_Make_전체시나리오_Router분기.png` | Make 전체 시나리오와 Router 분기 |
| 04 | `04_Make_Router_합격필터_80점이상.png.png` | Make 합격 경로 필터 |
| 05 | `05_Make_Router_불합격필터_80점미만.png.png` | Make 불합격 경로 필터 |
| 06 | `06_Make_합격경로_실행성공.png.png` | Make 합격 경로 실행 성공 |
| 07 | `07_Make_불합격경로_실행성공.png.png` | Make 불합격 경로 실행 성공 |
| 08 | `08_Make_GoogleSheets_합격자탭_기록결과.png.png` | Make 합격자 탭 기록 결과 |
| 09 | `09_Make_GoogleSheets_불합격자탭_기록결과.png.png` | Make 불합격자 탭 기록 결과 |
| 10 | `10_Make_Discord_합격불합격_알림결과.png.png` | Make Discord 합격·불합격 알림 |
| 11 | `11_Make_History_전체실행목록.png.png` | Make 실행 History 전체 |
| 12 | `12_Make_History_합격경로_상세로그.png.png` | Make 합격 경로 상세 로그 |
| 13 | `13_Make_History_불합격경로_상세로그.png.png` | Make 불합격 경로 상세 로그 |
| 14 | `14_Zapier_합격Zap_전체구성.png.png` | Zapier 합격 처리 Zap 전체 구성 |
| 15 | `15_Zapier_트리거_GoogleSheets설정.png.png` | Zapier Google Sheets Trigger 설정 |
| 16 | `16_Zapier_합격필터_80점이상.png.png` | Zapier 합격 필터 |
| 17 | `17_Zapier_시간대변환_Formatter설정.png.png` | Zapier UTC → Asia/Seoul 변환 |
| 18 | `18_Zapier_합격자시트_Action매핑.png.png` | Zapier 합격자 시트 Action 매핑 |
| 19 | `19_Zapier_합격Discord_Action설정.png.png` | Zapier 합격 Discord Action 설정 |
| 20 | `20_Zapier_불합격Zap_전체구성.png.png` | Zapier 불합격 처리 Zap 전체 구성 |
| 21 | `21_Zapier_불합격필터_80점미만.png.png` | Zapier 불합격 필터 |
| 22 | `22_Zapier_불합격자시트_Action매핑.png.png` | Zapier 불합격자 시트 Action 매핑 |
| 23 | `23_Zapier_불합격Discord_Action설정.png.png` | Zapier 불합격 Discord Action 설정 |
| 24 | `24_Zapier_두Zap_Live목록.png.png` | 합격·불합격 Zap 활성화 목록 |
| 25 | `25_Zapier_최종결과_합격자시트.png.png` | Zapier 합격자 시트 최종 결과 |
| 26 | `26_Zapier_최종결과_불합격자시트.png.png` | Zapier 불합격자 시트 최종 결과 |
| 27 | `27_Zapier_최종결과_Discord알림.png.png` | Zapier Discord 합격·불합격 최종 알림 |
| 28 | `28_Zapier_History_전체실행목록.png.png` | Zapier 성공·Filtered 실행 목록 |
| 29 | `29_Zapier_History_Filtered_상세로그.png.png` | Zapier Filtered 상세 로그 |
| 30 | `30_Zapier_TaskUsage_사용량현황.png.png` | Zapier Task 사용량 현황 |
