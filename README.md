...
| 항목 | 이미지 |
|---|---|
| Make 시나리오 전체 구성 | `images/make_scenario.png` |
| Make Router 조건 설정 | `images/make_router.png` |
| Make 실행 결과 | `images/make_run.png` |
| Zapier 합격 처리 Zap 전체 구성 | `images/03_Zapier_합격Zap_전체구성.png` |
| Zapier 불합격 처리 Zap 전체 구성 | `images/09_Zapier_불합격Zap_전체구성.png` |
| Zapier 합격 Filter 설정 | `images/05_Zapier_합격필터_80점이상.png` |
| Zapier 불합격 Filter 설정 | `images/10_Zapier_불합격필터_80점미만.png` |
| Zapier Formatter 시간대 변환 | `images/06_Zapier_시간대변환_Formatter설정.png` |
| Zapier 두 Zap 활성화 목록 | `images/13_Zapier_두Zap_Live목록.png` |
| 합격자 시트 결과 | `images/14_Zapier_최종결과_합격자시트.png` |
| 불합격자 시트 결과 | `images/15_Zapier_최종결과_불합격자시트.png` |
| Discord 합격·불합격 알림 | `images/16_Zapier_최종결과_Discord알림.png` |
| Zap History 전체 실행 목록 | `images/17_Zapier_History_전체실행목록.png` |
| Filtered 상세 로그 | `images/18_Zapier_History_Filtered_상세로그.png` |
| Zapier Task 사용량 | `images/19_Zapier_TaskUsage_사용량현황.png` |
